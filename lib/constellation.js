 ...
 */
async function goldbar(designName, langText, categories, numDesigns, maxCycles, representation, andTolerance, mergeTolerance) {
  designName = designName || 'constellation-design';
  numDesigns = numDesigns || 20;
  maxCycles = maxCycles || 0;
  representation = representation || EDGE;
  andTolerance = parseInt(andTolerance) || 0;
  mergeTolerance = parseInt(mergeTolerance) || 0;
  ...
  gra = graphGOLDBAR(sparsed, maxCycles, representation, categories, andTolerance, mergeTolerance);
  ...
  if (has(sparsed, 'And') || has(sparsed, 'Merge')) {
    ...
    graSBOL = graphGOLDBAR(sparsedSBOL, maxCycles, NODE, categories, andTolerance, mergeTolerance).stateGraph;
