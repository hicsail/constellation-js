...
async function goldbar(langText, categories,
  ...
  let messages = {exceedsDesigns: null};
  ...
  if (designs.totalNum > numDesigns) {
    messages.exceedsDesigns = `Displaying ${numDesigns} of approximately ${designs.totalNum} possible designs.  If there are specific parts you would like to see, please limit your category definitions to those parts.`;
  }
