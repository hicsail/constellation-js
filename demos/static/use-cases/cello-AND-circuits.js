...
let and0GOLDBAR = `(${oneOrMoreTU}) and0 (${exactlyOnePhlf}) and0 (${exactlyOneSrpr}) and0 (${exactlyOneAmtr})`;
...
let and1GOLDBAR_NORB = `(${noRoadblocking}) and1 ((${oneOrMoreTU}) and0 (${exactlyOnePhlf}) and0 (${exactlyOneSrpr}) and0 (${exactlyOneAmtr}))`;

// Cello AND circuit variants WITH roadblocking
let and1GOLDBAR_RB = `(${withRoadblocking}) and1 ((${oneOrMoreTU}) and0 (${exactlyOnePhlf}) and0 (${exactlyOneSrpr}) and0 (${exactlyOneAmtr}))`;
...
let and2GOLDBAR = `(${variablePhlf} and2 ${variableSrpr}) and1 ${variableAmtr}`;
